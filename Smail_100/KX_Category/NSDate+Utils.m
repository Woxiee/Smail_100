...
#define DATE_COMPONENTS (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | kCFCalendarUnitWeekday |  NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal)
...
+ (NSInteger)daysOffsetBetweenStartDateString:(NSString *)startDate endDateString:(NSString *)endDate{
    ...
    NSDateFormatter *dateFam = [[NSDateFormatter alloc]init];
    [dateFam setDateFormat:@"yyyy-MM-dd"];
    NSDate*date1  =[dateFam dateFromString:startDate];
    NSDate *date2 = [dateFam dateFromString:endDate];
    return  [self daysOffsetBetweenStartDate:date1 endDate:date2];
}
...
-(NSDateComponents*)getTheDateComponents
{
...
- (NSInteger)year
{
    NSDateComponents *dateComponents = [self getTheDateComponents];
...
- (NSString *)weekday
{
    ...
    comps =[calendar components:(kCFCalendarUnitWeekday | NSCalendarUnitWeekday |NSCalendarUnitWeekdayOrdinal)
                       fromDate:date];
...
+(NSInteger) daysBetweenStarDate:(NSDate*)starDate AndEndDate:(NSDate*)endDate
{
    //只取年月日比较
    // NSDate *dateStr = [NSDate dateStandardFormatTimeZeroWithDate:starDate];
    NSTimeInterval timeIntervalS = [starDate timeIntervalSince1970];
    // NSDate *dateEnd = [NSDate dateStandardFormatTimeZeroWithDate:starDate];
    NSTimeInterval timeIntervalE = [endDate timeIntervalSince1970];
    
    NSTimeInterval cha = timeIntervalE - timeIntervalS;
...
//
{
    ...
    if (timeInterval < 60) {
        ...
        result = [NSString stringWithFormat:@"%@",strDate];
    }
