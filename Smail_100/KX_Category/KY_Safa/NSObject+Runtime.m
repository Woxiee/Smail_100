...
{
#ifdef DEBUG
    NSString *aMessage = [NSString stringWithFormat:@"%@ == 出现异常，请检查",message];
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:aMessage message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
    [alert show];
    NSLog(@"%@",aMessage);
#endif
}
