...
//    searchBar.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    [[[searchBar.subviews objectAtIndex:0].subviews objectAtIndex:1] setTintColor:BACKGROUND_COLORHL];
...
- (void)setupHotSearchRectangleTags
{
    ...
    for (int i = 0; i < self.hotSearches.count; i++) {
        ...
        rectangleTagLabel.font = [UIFont systemFontOfSize:13];
        rectangleTagLabel.textColor = DETAILTEXTCOLOR;
        ...
        [rectangleTagLabel layerForViewWith:0 AndLineWidth:0.5];
