...
//    [goodsView addSubview:lineView];
//
//    selectBtn.selected = (_products.selectStatue.integerValue ==1);
//    [headImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",_products.img]] placeholderImage:[UIImage imageNamed:DEFAULTIMAGE]];
//    name.text = [NSString stringWithFormat:@"%@",_products.name];
//    priceLable.text = [NSString stringWithFormat:@"￥%@",[Common stringToTwoPoint:_products.price]];
//    number = [_products.goods_nums intValue];
//    numberLable.text = _products.itemCount;
//    productLabel.text =[NSString stringWithFormat:@"%@",_products.seller_name];
//}
//
