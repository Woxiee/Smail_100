...
- (void)setupViews{
  ...
  for (int i = 0; i<self.titleArray.count; i++) {
    ...
    [button setImage:[UIImage imageNamed:@"29@3x.png"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"28@3x.png"] forState:UIControlStateSelected];
    [button setTitleColor:TITLETEXTLOWCOLOR forState:UIControlStateNormal];
    button.titleLabel.font = Font15;
    [self buttonAddMovingLine:button];
    button.frame = CGRectMake(SCREEN_WIDTH / _titleArray.count *i, 0, SCREEN_WIDTH / _titleArray.count, 45);
  ...
  sepView.backgroundColor = LINECOLOR;
...
- (void)didClickButton:(UIButton *)button{
  ...
  [_selectedButton setTitleColor:TITLETEXTLOWCOLOR forState:UIControlStateNormal];
  [button setTitleColor:KMAINCOLOR forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"28@3x.png"] forState:UIControlStateSelected];
  _selectedButton = button;
...
- (void)buttonAddMovingLine:(UIButton *)button{
  ...
  movingLine.backgroundColor = KMAINCOLOR;
  movingLine.tag = 100;
