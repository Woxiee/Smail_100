...
@interface ProductDetailViewController ()<UIWebViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (void)setup
{
    ...
    _sameGoodsCollectView.backgroundColor = [UIColor redColor];
