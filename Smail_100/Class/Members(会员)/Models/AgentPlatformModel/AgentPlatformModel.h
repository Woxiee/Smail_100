...
@interface AgentPlatformModel : NSObject
...
@property (nonatomic , copy) NSString              * interest_perc;
...
@property (nonatomic , copy) NSString              * license_image;
@property (nonatomic , copy) NSString              * agreement_image;
