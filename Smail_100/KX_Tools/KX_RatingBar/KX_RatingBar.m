...
#import "KX_RatingBar.h"


@interface KX_RatingBar (){
    int starRating;
    int lastRating;
...
//    _s1.backgroundColor = [UIColor redColor];
    
    //星星图片之间的间距
    CGFloat space = (CGFloat)(viewWidth - width*5)/6;
    
    CGFloat startX = space;
    [_s1 setFrame:CGRectMake(startX, 0, width-2 , height-2)];
    startX += width + space-10;
    [_s2 setFrame:CGRectMake(startX, 0, width-2 , height-2)];
    startX += width + space-10;
    [_s3 setFrame:CGRectMake(startX, 0, width-2 , height-2)];
    startX += width + space-10;
    [_s4 setFrame:CGRectMake(startX, 0, width-2 , height-2)];
    startX += width + space-10;
    [_s5 setFrame:CGRectMake(startX, 0, width-2 , height-2)];
...
- (void)touchesRating:(NSSet *)touches{
    ...
    //星星图片之间的间距
    CGFloat space = (CGFloat)(self.frame.size.width - width*5 - 30)/6;
