...
- (void)customInterface
{
    ...
    CGFloat itemHeight = _collectionView.frame.size.width / 7 *hScale-10;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [cell.dateLabel setTextColor:RGB(181, 181, 181)];
        ...
        NSInteger day = 0;
       NSInteger selectDay =  [self day:_selectDate];
        ...
        if (i < firstWeekday) {
            ...
            [cell.dateLabel setTextColor:RGB(16, 18, 48)];

            if (day == selectDay) {
//                [cell.dateLabel setTextColor:[UIColor whiteColor]];
//                cell.backgroundColor = BACKGROUND_COLORHL;
            }else{
                cell.dateLabel.backgroundColor = [UIColor whiteColor];
            }
            //this month
            NSLog(@"_today= %@,_date= %@ ",_today,_date);
...
//                    cell.backgroundColor = BACKGROUND_COLORHL;
                ...
                NSLog(@"_today= %ld ",(long)[self day:_today]);

                if (day == [self day:_today]) {
                    [cell.dateLabel setTextColor:[UIColor whiteColor]];
                    cell.dateLabel.backgroundColor = BACKGROUND_COLORHL;
                    [cell.dateLabel layerForViewWith:20 AndLineWidth:0];
                    cell.dateLabel.font = [UIFont systemFontOfSize:19];
...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 1) {
        ...
        if (i >= firstWeekday && i <= firstWeekday + daysInThisMonth - 1) {
            ...
            } else if ([_date compare: _today] == NSOrderedDescending) {
                return YES;
            }else{
                return NO;
            }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *dateString = [NSString stringWithFormat:@"%ld-%ld-%ld",(long)[comp year],(long)[comp month],(long)day];
